...
export default class ShopPage extends Component {
  ...
  toggleDialog = (index, isOpen) => {
    //when index exists, the form is in edit mode. Otherwise it is in Add mode
    ...
    this.setState({
      ...
      curStartDate: indexExist
        ? moment(this.context.shop.start_date).format('MMMM Do, YYYY')
        : Date(),
      curEndDate: indexExist
        ? moment(this.context.shop.end_date).format('MMMM Do, YYYY')
        : Date(),
